...
public sealed record ScenarioRow(
    ...
    string ActionsJson,
    int ExpectedStackAfterSBA,
    string ExpectedTriggerOrderCsv,
    bool ExpectSingleReplacement);
...
{
    public static IEngineAdapter Instance { get; set; } = new EngineAdapterStub();
}
