...
public class APNAPTests
{
    ...
    public void Active_Player_Triggers_Resolve_Before_NonActive()
    {
        ...
        s = s.EnqueueTrigger(new SimpleTriggeredAbility(PlayerId.P1, () => new DrawCardAction())); // NAP
        s = s.EnqueueTrigger(new SimpleTriggeredAbility(PlayerId.P0, () => new DrawCardAction())); // AP
